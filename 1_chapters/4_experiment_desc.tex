...
After the pumps are deactivated at 22 km, the heating system aims to stabilize the chamber temperature at $-5$°C. This is done as a proxy to prevent the electronics in the chassis from freezing.\par 
