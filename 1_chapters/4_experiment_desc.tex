...
Despite these potential dimensional refinements, current material analysis confirms that polymeric foams will remain the baseline choice for the insulation architecture.\par 

\begin{figure}
  \centering 
  \includegraphics{0_images/figures/insulation_selection_material.png}
\end{figure}
