...
To engage the correct flight phases, longer term changes in the recorded ambient pressure or via a command from the ground are used, with the command taking priority. A control flow and state diagram are provided in Figure \ref{fig:cont_flow} and Figure \ref{fig:state_diagram}.

\subsection{Main MCU}

The settings of the thermal and pressure subsystems depend on the readings of the internal and external pressure and temperature sensors. 
These will be provided to the slave \gls{mcu}s via the Main (Master) \gls{mcu}.
