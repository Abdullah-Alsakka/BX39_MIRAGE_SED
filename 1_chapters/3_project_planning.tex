...
\rowcolor{lowyellow} TC161 & Linear regulator overheating due to high power dissipation, causing lower output and thermal shutdown & B & 4 & medium & Acceptable risk \\
...
\rowcolor{mediumorange} TC221 & Transient behavior not accounted for, creating hidden failure points and unpredictable consequences & B & 4 & low & Acceptable risk \\
\end{longtable}
% %
% %\begin{landscape}
% %\begin{table}[H]
